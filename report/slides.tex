...
%
\title{FLIP00 Final Assessment}%主标题
\author{
Cong Ma%作者
\\
...
cf={ FLIP00 Final Assessment },%会议名称同主标题
}
...
{    Kobe Bryant marked his retirement from the NBA 
by scoring 60 points in his final game as a Los Angeles
 Laker on Wednesday, April 12, 2016. Drafted into the
 NBA at the age of 17, Kobe earned the sport’s highest 
accolades throughout his long career.
    Using 20 years of data on Kobe's swishes and misses, 
can you predict which shots will find the bottom of the net?
 This competition is well suited for practicing classification basics,
 feature engineering, and time series analysis. Practice got Kobe 
an eight-figure contract and 5 championship rings. What will you get from it?
...
\begin{itemize}
\item
Step One - \textcolor{green}{Check the data ,Data cleaning,Data process}
\item
Step Two - \textcolor{orange}{Data visualization}
\item
...
\section{Check the data ,Data cleaning,Data process}
...
%%==========================================================================================
%%
\begin{slide}{Check the data ,Data cleaning,Data process}
 ...
 \begin{center}
    \includegraphics[width=.9\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/data.eps}
 \end{center}


 \item
 \textcolor{orange}{There must be variables in so much data that have nothing to do with our model, and we will remove them in some way.}
 \end{itemize}
...
\begin{itemize}
 \item
 \textcolor{blue}{We need to eliminate duplicate data before we build models.}

 \item
 \textcolor{blue}{Encoded the data by one-hot.}
...
\item
\smallskip
During this past month I have learned how use Latex,git and so on.
There is no doubt that I have encountered a lot of problems in this short time.
and it exercise my ability to learn independently.

\item
\smallskip
After a month of study in flip00,I have benifit quite a lot.
I not only learned how to use software,but also gained friends.
