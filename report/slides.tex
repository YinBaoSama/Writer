...
%
\title{FLIP01 Interim Assessment}%主标题 %Interim 期中  %Final 期末
\author{
Cong Ma%作者
\\
...
cf={ FLIP01 Interim Assessment },%会议名称同主标题
}
...
%%==========================================================================================
%%
\begin{slide}{Kaggle Project Introduce}%副标题
\begin{center}
\twotonebox{\rotatebox{90}{Defn}}{\parbox{.86\textwidth}
{    With all of the tweets circulating every second it is 
hard to tell whether the sentiment behind a specific tweet will 
impact a company, or a person's, brand for being viral (positive), 
or devastate profit because it strikes a negative tone. Capturing
sentiment in language is important in these times where decisions 
and reactions are created and updated in seconds. But, which words 
actually lead to the sentiment description? In this competition you
will need to pick out the part of the tweet (word or phrase) that 
reflects the sentiment.\\
  In this competition we've extracted support phrases from Figure 
  Eight's Data for Everyone platform. The dataset is titled Sentiment 
  Analysis: Emotion in Text tweets with existing sentiment labels, 
  used here under creative commons attribution 4.0. international
   licence. Your objective in this competition is to construct a model 
   that can do the same - look at the labeled sentiment for a given 
   tweet and figure out what word or phrase best supports it.
...
\section{Overall Research Ideas}


%%==========================================================================================
%%
\begin{slide}{Overall Research Ideas}
%Related Work - Outlying Aspects Mining
\begin{itemize}
\item
Step One - \textcolor{green}{Download and Check the data ; Data process}
\item
Step Two - \textcolor{orange}{Constructing emotion dictionary}
\item
Step Three - \textcolor{blue}{Build the model and select the optimal parameters }
\item
Step Three - \textcolor{red}{Visualization parameters and process the test data }
...
\section{Download and Check the data ; Data process}
...
%%==========================================================================================
%%
\begin{slide}{Check the data }

 \begin{itemize}
  \item
 \textcolor{orange}{First,let's check the data.}

 \begin{center}
    \includegraphics[width=.9\linewidth,height=.3\linewidth]{D:/filp/program/Writer.git/data/data.eps}
 \end{center}


 \item
 \textcolor{orange}{We will extract the eigenvalues from these texts.}
 \end{itemize}



\end{slide}
%[toc=,bm=]可以把一样的下面的页面合并在一起
%locxy
...
%     \item
%    \textcolor{orange}{After we delete  blank data,we create charts to check the relationship between variable.}

%   \begin{center}
%       \includegraphics[width=.5\linewidth,height=.4\linewidth]{D:/filp/program/Kobe.git/data/locxy.eps}
%   \end{center}

%   \item
%    \textcolor{orange}{We can make sure that the shooting position and latitude and longitude are basically consistent with the court.}
%  \end{itemize}
...
%    \begin{center}
%       \includegraphics[width=.8\linewidth,height=.5\linewidth]{D:/filp/program/Kobe.git/data/shotzone.eps}
%    \end{center}

% \begin{itemize}
%   \item
%   \textcolor{orange}{The shotzone also has the same characteristic whth the lat and lon.}
...
%   \begin{center}
%      \includegraphics[width=.5\linewidth,height=.5\linewidth]{D:/filp/program/Kobe.git/data/shotarea.eps}
%   \end{center}

% \begin{itemize}
%  \item
%  \textcolor{orange}{The shottype also has the same characteristic whth the lat and lon.}
...
%   \begin{center}
%      \includegraphics[width=.6\linewidth,height=.5\linewidth]{D:/filp/program/Kobe.git/data/attack.eps}
%   \end{center}

% \begin{itemize}
%  \item
%  \textcolor{orange}{Kobe's way of shooting, it is clear that the most jump shot.}
...
%   \begin{center}
%      \includegraphics[width=.6\linewidth,height=.4\linewidth]{D:/filp/program/Kobe.git/data/getpoint.eps}
%   \end{center}

% \begin{itemize}
%  \item
%  \textcolor{orange}{On the shooting percentage, the dunk is undoubtedly the highest.}
...
%   \begin{center}
%      \includegraphics[width=.7\linewidth,height=.5\linewidth]{D:/filp/program/Kobe.git/data/shotnumber.eps}
%   \end{center}

% \begin{itemize}
%  \item
%  \textcolor{orange}{From the shooting distance, most of Kobe is in the middle distance.}
...
%   \begin{center}
%      \includegraphics[width=.6\linewidth,height=.4\linewidth]{D:/filp/program/Kobe.git/data/period.eps}
%   \end{center}

% \begin{itemize}
%  \item
%  \textcolor{orange}{Kobe's shooting times in each quarter are the most in the third quarter and the second in the first quarter.}
%  \item
%  \textcolor{orange}{Because the 5, 6 and 7 quarters are overtime games, naturally much less.}
% \end{itemize}
...
%   \begin{center}
%      \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/peget.eps}
%   \end{center}

% \begin{itemize}
%  \item
%  \textcolor{orange}{The shooting percentage of each section can be seen that Kobe's shooting percentage is the lowest in the fourth quarter.}
%  \item
%  \textcolor{orange}{It can be seen that physical strength has some influence on Kobe's shooting percentage.}
% \end{itemize}
...
%   \begin{center}
%      \includegraphics[width=.5\linewidth,height=.6\linewidth]{D:/filp/program/Kobe.git/data/final.eps}
%   \end{center}
...
\section{Constructing emotion dictionary}
\vspace{1cm}%%%这个东西能够把页码整对

\begin{slide}{Constructing emotion dictionary}

\begin{itemize}
 \item
 \textcolor{blue}{We need to count the frequency of each word.}

  \item
  \textcolor{blue}{Based on this, an emotional dictionary is constructed.}

%  \item
%  \textcolor{blue}{Choose K-fold verification and the minimum value of loss and the number of optimal trees, the optimal value of maximum depth.}

\end{itemize}

\end{slide}

\begin{slide}[toc=,bm=]{Constructing emotion dictionary}

   \begin{center}
      \includegraphics[width=.8\linewidth,height=.4\linewidth]{D:/filp/program/Writer.git/data/dic.eps}
   \end{center}

\begin{itemize}
  \item
  \textcolor{blue}{The initial construction of emotion dictionary has been completed.}
...
% \begin{slide}{Build and train the model and produce the submission data}

%   \begin{center}
%       \includegraphics[width=.7\linewidth,height=.5\linewidth]{D:/filp/program/Kobe.git/data/deptree.eps}
%    \end{center}
...
% %下面这些涉及很多格式以后可能会用到
%  \item
% After a month of study in flip00，I have benifit quite a lot.

% \item
% I not only learned how to use software, but also gained friendship.
...
\item
\smallskip
During this past few weeks , I've learned pattern recognition and 
Matrix_Analysis from the Flip01 videos.Write some simple spider program.//
In addition , I also learned some algorithms of machine learning,such as CNN , MLP , Alexnet , SVM.

\item
\smallskip
In the coming month I would like to learn the notebook , accomplish the Kaggle competition title.
And keep learning Matrix_Analysis and machine learning .
